...
## 18. Short participant invitation

### English

Hi, I am looking for one participant for a short developer study for my MSc dissertation. The study involves using a prepared Unity project and the IVA SDK to create a minimal virtual stand-in. It will take around 45–50 minutes and focuses on the development process rather than testing your programming ability. You should be 18+ and have basic Unity/C# experience. Participation is voluntary, and the dissertation will use an anonymised participant ID. Please let me know if you may be available.

### Chinese

你好，我正在为硕士论文招募一名开发者参加一个简短实验。你需要使用我准备好的Unity项目和IVA SDK，完成一个最小的"虚拟替身"任务。实验大约45–50分钟，主要观察SDK的使用过程，不是考察你的编程水平。参与者需年满18岁，并具备基本的Unity/C#经验。参与完全自愿，论文中只会使用匿名编号。如果你愿意参加，可以告诉我你的时间。
